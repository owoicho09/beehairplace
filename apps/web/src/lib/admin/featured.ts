...
/**
 * The featured section is intentionally small (it's the ~3 autoplay
 * showcase on the homepage) — enforced here so it can't be bypassed from
 * either place that can set isFeatured (the product edit form, and the
 * homepage merchandising picker).
 */
